...
class UserFriendshipsControllerTest < ActionController::TestCase
  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "assign a new user friendship with jim" do
        get :new, friend_id: users(:jim)
      ...
      should "assign a new user friendship to the currently logged in user" do
        get :new, friend_id: users(:jim)
        assert_equal users(:johnmurphy), assigns(:user_friendship).user
      end      
  ...
  context "#create" do
    ...
    context "when logged in" do
      ...
      context "with no friend_id" do
        ...
        should "set the flash error maessage" do
    ...
    context "with a valid friend_id" do
      ...
      should "create a friendship" do
        assert users(:johnmurphy).pending_friends.include?(users(:mike))
      end
  ...
  context "#accept" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:pending_user_friendship, user: users(:johnmurphy), friend: @friend)
        create(:pending_user_friendship, friend: users(:johnmurphy), user: @friend)
        sign_in users(:johnmurphy)
    ...
    context "when logged in" do
      setup do
        @user_friendship = create(:pending_user_friendship, user: users(:johnmurphy))
        sign_in users(:johnmurphy)
  ...
  context "#destroy" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:johnmurphy))
        create(:accepted_user_friendship, friend: users(:johnmurphy), user: @friend)
        sign_in users(:johnmurphy)
